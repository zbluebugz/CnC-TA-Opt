// ==UserScript==
// @version       1.0.7.1
// @name          CnC:TA CnCTAOpt Link (beta)
...
try {
    (function () {
                ...
                const cnctaopt = {
                    ...
                    make_sharelink: function () {
                        try {
                            ...
                            link += "~ML=" + maxLevel;
                            link = "http://www.cnctaopt.com/beta/index.html?" + encodeURI(link);
                            //link = "http://cnctabaselayout.net/?" + encodeURI(link);
                            // console.log(link);
                            ...
                            for (let i in this) {
                                try {
                                    if (this[i] && this[i].basename == "Composite") {
                                        let link = new qx.ui.form.Button("CnCTAOpt (beta v3)", "http://cnctaopt.com/favicon.ico");
        ...
        script_block.innerHTML = "(" + cnctaopt_beta.toString() + ")();";
        if (/commandandconquer\.com/i.test(document.domain)) {
